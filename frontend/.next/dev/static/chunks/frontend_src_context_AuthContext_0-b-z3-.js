...
const AuthProvider = ({ children })=>{
    ...
    // ENVIRONMENT VARIABLE: Using Next.js environment variable for API base URL
    // This follows production best practices and allows easy configuration across environments
